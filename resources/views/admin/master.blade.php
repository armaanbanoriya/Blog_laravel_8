...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{url('admin/dist/img/IMG_20190723_182751.jpg')}}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Armaan Banoriya</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{url("admin/addblog")}}" class="nav-link {{ 'admin/addblog' == request()->path() ? 'active' : '' }}">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Add Blogs
              </p>
          ...
          <li class="nav-item">
            <a href="{{url("admin/display")}}" class="nav-link {{ 'admin/display' == request()->path() ? 'active' : '' }} ">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                View Blogs
              </p>
          ...
          <li class="nav-item">
            <a href="{{url("logout")}}" class="nav-link {{ 'logout' == request()->path() ? 'active' : '' }} ">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Logout
              </p>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="">Armaan Banoriya</a>.</strong>
    All rights reserved.
